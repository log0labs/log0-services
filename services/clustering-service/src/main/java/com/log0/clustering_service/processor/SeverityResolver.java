...
public class SeverityResolver {
    /**
     * Returns {@code "HIGH"} for FATAL/ERROR (and null), {@code "MEDIUM"} for WARN, and
     * {@code "LOW"} for everything else. Comparison is case-insensitive.
     *
     * @param level raw log level (e.g. {@code "ERROR"}, {@code "warn"}); may be null
     * @return normalized severity string: {@code "HIGH"}, {@code "MEDIUM"}, or {@code "LOW"}
     */
